...
$HTML_tbody = '
            <tr>
                ...
                <td>%s</td>
                <td>
                    <form action="http://localhost:8080/fg/inventario_site/v2/pages/departamentos/delete.php" method="post">
                        <input type="hidden" name="id" value="%s">
                        <button type="submit" class="btn btn-danger">Eliminar</button>
                    </form>
                    <form action="http://localhost:8080/fg/inventario_site/v2/pages/departamentos/formUpdate.php" method="post">
                        <input type="hidden" name="id" value="%s">
