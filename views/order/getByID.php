...
<div class="row mt-4">
    <div class="col-lg-5 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="%sorder/update" method="post">
                    <div class="mb-3">
...
';
printf($form_update,constant('URL_HOME'),$this->data['id'],$this->data['folio'],$this->data['estado'],$this->data['descripcion'],$this->data['departamento'],$this->data['trabajador'],$this->data['fecha_i'],$this->message)
?>